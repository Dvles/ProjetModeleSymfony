 ...
 */
final class Version20240903120848 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE date_emprunt (id INT AUTO_INCREMENT NOT NULL, date DATE DEFAULT NULL, date_retour DATE DEFAULT NULL, date_emprunt DATE DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE date_emprunt');
